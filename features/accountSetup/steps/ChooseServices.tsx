...
import { IconDrag, IconEdit, IconPlus, IconXCircle } from '@/assets/icons/icons'
...
import {
  getHoursFromMinutes,
  getOnlyMinutes,
} from '../helpers/durationConverters'
import { useChoseServices } from '../hooks/useChooseServices'
                                  ...
                                  {(provided) => {
                                    return (
                                      ...
                                      >
                                        ...
                                        >
                                          <IconPlus className="mr-3 group-hover:text-orange" />
                                          <H16 className="group-hover:text-orange">
...
const ServiceTitle: React.FC<IServiceTitle> = ({
  ...
  return (
    <div className="flex items-center justify-between px-5 mb-5 small:px-0">
      <div className="flex items-center h-1 gap-x-4">
        <span {...dragHandleProps}>
          <IconDrag className="cursor-pointer" />
        </span>
        <div
